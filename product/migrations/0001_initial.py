# Generated by Django 4.1.5 on 2023-01-09 07:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('retails', models.ManyToManyField(related_name='products', to='product.retail', verbose_name='Retail stores that carry the product')),
            ],
        ),
    ]
